...
<div class="container">
    ...
    <form id="fileupload" action="/users_interface/uploadfilestoserver/" method="POST" enctype="multipart/form-data">
...
<script src="/assets/js/fileupload/jquery.fileupload-jui.js"></script>
